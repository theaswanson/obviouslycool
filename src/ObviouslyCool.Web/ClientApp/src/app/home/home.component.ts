...
import { faTwitter, faYoutube, faTwitch, faGithub, faSteam, IconDefinition, faDiscord } from '@fortawesome/free-brands-svg-icons';
...
export class HomeComponent {
  ...
  socials: Social[] = [
    ...
    new Social(this.faDiscord, 'https://discord.gg/2DFqfgVVYm'),
